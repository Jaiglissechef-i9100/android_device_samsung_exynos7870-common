...
TARGET_LD_SHIM_LIBS += \
    ...
    /system/lib64/omx/libOMX.Exynos.AVC.Decoder.so|libstagefright_shim.so \
    /system/lib64/omx/libOMX.Exynos.AVC.Encoder.so|libstagefright_shim.so \
    /system/lib64/omx/libOMX.Exynos.HEVC.Decoder.so|libstagefright_shim.so \
    /system/lib64/omx/libOMX.Exynos.HEVC.Encoder.so|libstagefright_shim.so \
    /system/lib64/omx/libOMX.Exynos.MPEG4.Decoder.so|libstagefright_shim.so \
    /system/lib64/omx/libOMX.Exynos.MPEG4.Encoder.so|libstagefright_shim.so \
    /system/lib64/omx/libOMX.Exynos.VP8.Decoder.so|libstagefright_shim.so \
    /system/lib64/omx/libOMX.Exynos.VP8.Encoder.so|libstagefright_shim.so \
    /system/lib64/omx/libOMX.Exynos.VP9.Decoder.so|libstagefright_shim.so \
    /system/lib64/omx/libOMX.Exynos.WMV.Decoder.so|libstagefright_shim.so
